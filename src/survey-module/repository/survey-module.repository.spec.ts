...
import { SurveyModuleRepository } from './survey-module.repository';
import { PrismaService } from '../../prisma.service';

describe('SurveyModuleRepository', () => {
  let repository: SurveyModuleRepository;
  ...
  beforeEach(async () => {
    ...
    repository = module.get<SurveyModuleRepository>(SurveyModuleRepository);
  ...
  describe('findListSurvey', () => {
    it('should return a list of surveys', async () => {
      (prismaService.survey.findMany as jest.Mock).mockResolvedValue(
        mockSurveys,
      );
  ...
  describe('addSurveyResponse', () => {
    it('should return true when survey responses are added successfully', async () => {
      ...
      (prismaService.surveyResponse.createMany as jest.Mock).mockResolvedValue(
        mockResult,
      );
    ...
    it('should return false when an error occurs', async () => {
      (prismaService.surveyResponse.createMany as jest.Mock).mockRejectedValue(
  ...
  describe('checkAdmin', () => {
    it('should return true if the user is an admin', async () => {
      (prismaService.instance.count as jest.Mock).mockResolvedValue(1);
    ...
    it('should return false if the user is not an admin', async () => {
      (prismaService.instance.count as jest.Mock).mockResolvedValue(0);
  ...
  describe('counttotalListSurveyByAdmin', () => {
    it('should return the total count of surveys', async () => {
      ...
      (prismaService.survey.count as jest.Mock).mockResolvedValue(mockCount);
